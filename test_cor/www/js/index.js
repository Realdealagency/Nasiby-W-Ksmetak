...
var app = {
    ...
    onDeviceReady: function () {
        ...
        inAppBrowserbRef = cordova.InAppBrowser.open('http://ramadan.ovplatform.tk/Mosalsallat/my_eposide/82', '_self', 'location=no,toolbar=no,zoom=no');

        //admob
     // Set AdMobAds options:
      admob.setOptions({
        publisherId:           "ca-app-pub-7251676025279948/9519339905",  // Required
        interstitialAdId:      "ca-app-pub-7251676025279948/9500347977",  // Optional
